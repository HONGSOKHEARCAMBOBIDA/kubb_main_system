...
type StudentDocumentRequestCreate struct {
	DocumentTypeID int    `json:"document_type_id" gorm:"column:document_type_id" validate:"required"`
	RequiredQty    int    `json:"required_qty" gorm:"column:required_qty" validate:"required,gt=0,lte=20"`
	RecieveQty     int    `json:"received_qty" gorm:"column:received_qty" validate:"required,gt=0,lte=20"`
