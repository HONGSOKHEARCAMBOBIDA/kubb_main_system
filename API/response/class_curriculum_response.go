...
type ClasCurriculumnResponseWithTeacherRate struct {
	base.ModelBase
	base.UUIDBase
	Name                                         string                                         `json:"name" gorm:"column:name"`
	Active                                       bool                                           `json:"active" gorm:"column:active"`
	...
	AcademicCode                                 string                                         `json:"academic_code"`
	AcademicName                                 string                                         `json:"academic_name"`
	ClasCurriculumnDetailResponseWithTeacherRate []ClasCurriculumnDetailResponseWithTeacherRate `json:"class_curriculum_detais" gorm:"-"`
}
