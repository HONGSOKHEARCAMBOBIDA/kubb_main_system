...
func SetupRoutes(r *gin.Engine) {
	...
	auth.Use(middleware.AuthMiddleware())
	{
		...
		auth.GET(route.TermViewByGeneration, middleware.PermissionMiddleware(permission.CRUDTERM), termcontroller.GetTermByGeneration)
		...
		auth.PUT(route.ClassCurriculumnDelete, middleware.PermissionMiddleware(permission.CRUDCLASSCURRICULMN), classcurriculumcontroller.Toggle)
		...
		// Attendance
		auth.POST(route.AttendanceCreate, middleware.PermissionMiddleware(permission.CRUDATTENDANCE), attendancecontroller.CreateAttendance)
		auth.GET(route.AttendanceView, middleware.PermissionMiddleware(permission.CRUDATTENDANCE), attendancecontroller.GetAttendance)
